...
def main():
    ...
    blur_image(training_dataset_directory, "png/lighthouse.png")
    intensity_based_template_matching_training(training_dataset_directory)
    intensity_based_template_matching_testing("../dataset/Training/templates")
...
def intensity_based_template_matching_testing(templates_dir):
    """
    ...
    for classname in os.listdir(templates_dir):
        ...
        for t in os.listdir(templates_dir + "/" + classname + "/"):
            ...
            template = np.load(templates_dir + "/" + classname + "/" + t, mmap_mode=None, allow_pickle=True,
